...
public class CommercialStopGenerator extends AbstractGenerator
{
	 ...
	 * 
	 * @param boardingPositions list of input boarding positions 
	 ...
	 * 
	 * @param area  commercial stop point
	...
	/**
	 * divide commercial stop point into smaller ones if boarding positions are too far
	 * <br/> recursive method
	 * 
	 ...
	 */
	private void explodeArea(List<StopArea> dividedAreas, StopArea area,int rank,String baseId,double distanceMax) 
	{
